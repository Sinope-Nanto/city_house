...
import local_admin.views.result_views as result_views
...
urlpatterns = [
    ...
    path("upload_status/send_sms", status_view.SendSMSViews.as_view()),
    ...
    path("result/warning", result_views.ListCityCalculateWarnResultView.as_view())
]
