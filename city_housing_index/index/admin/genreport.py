...
class GenExcelReport:
    ...
    def IndexSummary(self, **kwargs):
        ...
        borderrow = [i for i in range(2, 10)] + [11, 12] + [i for i in range(16, 21)] + [i for i in range(22, 30)] + [
            31, 32, 33, 34] + [i for i in range(36, 42)] + [44, 45]
        for i in borderrow:
            for j in range(1, col_max):
                c = indexsummary.cell(row=i, column=j)
    ...
    def Attach(self, year: int, month: int, citylist: list, **kwargs):
        ...
        if float(kwargs['east_year_on_year'][len(kwargs['east_index']) - 1]) > 0:
            tit = p.add_run('上涨' + str(
                float('%.2f' % (float(kwargs['east_year_on_year'][len(kwargs['east_index']) - 1]) * 100))) + '%，环比')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        else:
            tit = p.add_run(
                '下降' + str(float(
                    '%.2f' % (float(-kwargs['east_year_on_year'][len(kwargs['east_index']) - 1]) * 100))) + '%，环比')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        ...
        if float(kwargs['east_chain'][len(kwargs['east_index']) - 1]) > 0:
            tit = p.add_run(
                '上涨' + str(float('%.2f' % (float(kwargs['east_chain'][len(kwargs['east_index']) - 1]) * 100))) + '%；')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        else:
        ...
        if float(kwargs['mid_year_on_year'][len(kwargs['mid_index']) - 1]) > 0:
            tit = p.add_run(
                '上涨' + str(
                    float('%.2f' % (float(kwargs['mid_year_on_year'][len(kwargs['mid_index']) - 1]) * 100))) + '%，环比')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        else:
        ...
        if float(kwargs['mid_chain'][len(kwargs['mid_index']) - 1]) > 0:
            tit = p.add_run(
                '上涨' + str(float('%.2f' % (float(kwargs['mid_chain'][len(kwargs['mid_index']) - 1]) * 100))) + '%；')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        else:
        ...
        if float(kwargs['west_year_on_year'][len(kwargs['west_index']) - 1]) > 0:
            tit = p.add_run(
                '上涨' + str(
                    float('%.2f' % (float(kwargs['west_year_on_year'][len(kwargs['west_index']) - 1]) * 100))) + '%，环比')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        else:
            tit = p.add_run(
                '下降' + str(float(
                    '%.2f' % (-float(kwargs['west_year_on_year'][len(kwargs['west_index']) - 1]) * 100))) + '%，环比')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        ...
        if float(kwargs['west_chain'][len(kwargs['west_index']) - 1]) > 0:
            tit = p.add_run(
                '上涨' + str(float('%.2f' % (float(kwargs['west_chain'][len(kwargs['west_index']) - 1]) * 100))) + '%。')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        else:
        ...
        if float(kwargs['year_on_year_under_90'][len(kwargs['index_under_90']) - 1]) > 0:
            tit = p.add_run(
                '上涨' + str(float('%.2f' % (
                            float(kwargs['year_on_year_under_90'][len(kwargs['index_under_90']) - 1]) * 100))) + '%，环比')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        else:
            tit = p.add_run(
                '下降' + str(float('%.2f' % (-float(
                    kwargs['year_on_year_under_90'][len(kwargs['index_under_90']) - 1]) * 100))) + '%，环比')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        ...
        if float(kwargs['chain_under_90'][len(kwargs['index_under_90']) - 1]) > 0:
            tit = p.add_run('上涨' + str(
                float('%.2f' % (float(kwargs['chain_under_90'][len(kwargs['index_under_90']) - 1]) * 100))) + '%；')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        else:
        ...
        if float(kwargs['year_on_year_90_144'][len(kwargs['index_90_144']) - 1]) > 0:
            tit = p.add_run(
                '上涨' + str(float(
                    '%.2f' % (float(kwargs['year_on_year_90_144'][len(kwargs['index_90_144']) - 1]) * 100))) + '%，环比')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        else:
        ...
        if float(kwargs['chain_90_144'][len(kwargs['index_90_144']) - 1]) > 0:
            tit = p.add_run('上涨' + str(
                float('%.2f' % (float(kwargs['chain_90_144'][len(kwargs['index_90_144']) - 1]) * 100))) + '%；')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        else:
        ...
        if float(kwargs['year_on_year_above_144'][len(kwargs['index_above_144']) - 1]) > 0:
            tit = p.add_run(
                '上涨' + str(float('%.2f' % (float(
                    kwargs['year_on_year_above_144'][len(kwargs['index_above_144']) - 1]) * 100))) + '%，环比')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        else:
        ...
        if float(kwargs['chain_above_144'][len(kwargs['index_above_144']) - 1]) > 0:
            tit = p.add_run('上涨' + str(
                float('%.2f' % (float(kwargs['chain_above_144'][len(kwargs['index_above_144']) - 1]) * 100))) + '%。')
            tit.font.name = '仿宋_GB2312'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '仿宋_GB2312')
            tit.font.size = Pt(14)
        else:
...
class GenWordPicture:
    ...
    def genpicdoc(self, year: int, month: int, citylist: list, **kwargs):
        ...
        for i in range(40):
            ...
            p.paragraph_format.alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
            tit = p.add_run(
                '图' + str(i + 1) + '  ' + citylist[i] + '市“城房指数”（2006.1~' + str(year) + '.' + str(month) + '）')
            tit.font.name = '宋体'
            tit.element.rPr.rFonts.set(qn('w:eastAsia'), '宋体')
